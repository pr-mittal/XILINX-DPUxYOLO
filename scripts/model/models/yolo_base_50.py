...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.module_3 = torch.nn.Conv2d(in_channels=48, out_channels=24, kernel_size=[3, 3], stride=[2, 2], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/Conv[model]/Conv[1]/Conv2d[conv]/input.9
        self.module_4 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/Conv[model]/Conv[1]/torch.nn.BatchNorm2d2d[bn]/input.11
        ...
        self.module_6 = torch.nn.Conv2d(in_channels=24, out_channels=16, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[2]/Conv[cv1]/Conv2d[conv]/input.15
        self.module_7 = torch.nn.BatchNorm2d(num_features=16, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[2]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.17
        ...
        self.module_21 = torch.nn.Conv2d(in_channels=24, out_channels=24, kernel_size=[1, 1], stride=[1, 1],
                                         padding=[0, 0], dilation=[1, 1], groups=1,
                                         bias=False)  # Model::Model/C3[model]/C3[2]/Conv[cv2]/Conv2d[conv]/input.43
        self.module_22 = torch.nn.BatchNorm2d(num_features=24, eps=0.001,
        ...
        self.module_24 = torch.nn.Conv2d(in_channels=40, out_channels=96, kernel_size=[1, 1], stride=[1, 1],
                                         padding=[0, 0], dilation=[1, 1], groups=1,
        ...
        self.module_9 = torch.nn.Conv2d(in_channels=16, out_channels=24, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[0]/Conv[cv1]/Conv2d[conv]/input.21
        self.module_10 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[0]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.23
        ...
        self.module_12 = torch.nn.Conv2d(in_channels=24, out_channels=16, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[0]/Conv[cv2]/Conv2d[conv]/input.27
        self.module_13 = torch.nn.BatchNorm2d(num_features=16, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[0]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.29
        ...
        self.module_15 = torch.nn.Conv2d(in_channels=16, out_channels=24, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[1]/Conv[cv1]/Conv2d[conv]/input.33
        self.module_16 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[1]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.35
        ...
        self.module_18 = torch.nn.Conv2d(in_channels=24, out_channels=16, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[1]/Conv[cv2]/Conv2d[conv]/input.39
        self.module_19 = torch.nn.BatchNorm2d(num_features=16, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[2]/Sequential[m]/Bottleneck[1]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.41
        ...
        self.module_27 = torch.nn.Conv2d(in_channels=96, out_channels=144, kernel_size=[3, 3], stride=[2, 2], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/Conv[model]/Conv[3]/Conv2d[conv]/input.55
        self.module_28 = torch.nn.BatchNorm2d(num_features=144, eps=0.001, momentum=0.03) #Model::Model/Conv[model]/Conv[3]/torch.nn.BatchNorm2d2d[bn]/input.57
        ...
        self.module_30 = torch.nn.Conv2d(in_channels=144, out_channels=24, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Conv[cv1]/Conv2d[conv]/input.61
        self.module_31 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.63
        ...
        self.module_57 = torch.nn.Conv2d(in_channels=144, out_channels=72, kernel_size=[1, 1], stride=[1, 1],
                                         padding=[0, 0], dilation=[1, 1], groups=1,
                                         bias=False)  # Model::Model/C3[model]/C3[4]/Conv[cv2]/Conv2d[conv]/input.113
        self.module_58 = torch.nn.BatchNorm2d(num_features=72, eps=0.001,
        ...
        self.module_60 = torch.nn.Conv2d(in_channels=96, out_channels=96, kernel_size=[1, 1], stride=[1, 1],
                                         padding=[0, 0], dilation=[1, 1], groups=1,
                                         bias=False)  # Model::Model/C3[model]/C3[4]/Conv[cv3]/Conv2d[conv]/input.119
        self.module_61 = torch.nn.BatchNorm2d(num_features=96, eps=0.001,
        ...
        self.module_33 = torch.nn.Conv2d(in_channels=24, out_channels=48, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[0]/Conv[cv1]/Conv2d[conv]/input.67
        self.module_34 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[0]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.69
        ...
        self.module_36 = torch.nn.Conv2d(in_channels=48, out_channels=24, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[0]/Conv[cv2]/Conv2d[conv]/input.73
        self.module_37 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[0]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.75
        ...
        self.module_39 = torch.nn.Conv2d(in_channels=24, out_channels=48, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[1]/Conv[cv1]/Conv2d[conv]/input.79
        self.module_40 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[1]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.81
        ...
        self.module_42 = torch.nn.Conv2d(in_channels=48, out_channels=24, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[1]/Conv[cv2]/Conv2d[conv]/input.85
        self.module_43 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[1]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.87
        ...
        self.module_45 = torch.nn.Conv2d(in_channels=24, out_channels=48, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[2]/Conv[cv1]/Conv2d[conv]/input.91
        self.module_46 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[2]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.93
        ...
        self.module_48 = torch.nn.Conv2d(in_channels=48, out_channels=24, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[2]/Conv[cv2]/Conv2d[conv]/input.97
        self.module_49 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[2]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.99
        ...
        self.module_51 = torch.nn.Conv2d(in_channels=24, out_channels=48, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[3]/Conv[cv1]/Conv2d[conv]/input.103
        self.module_52 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[3]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.105
        ...
        self.module_54 = torch.nn.Conv2d(in_channels=48, out_channels=24, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[3]/Conv[cv2]/Conv2d[conv]/input.109
        self.module_55 = torch.nn.BatchNorm2d(num_features=24, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[4]/Sequential[m]/Bottleneck[3]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.111
        ...
        self.module_63 = torch.nn.Conv2d(in_channels=96, out_channels=96, kernel_size=[3, 3], stride=[2, 2], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/Conv[model]/Conv[5]/Conv2d[conv]/input.125
        self.module_64 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/Conv[model]/Conv[5]/torch.nn.BatchNorm2d2d[bn]/input.127
        ...
        self.module_66 = torch.nn.Conv2d(in_channels=96, out_channels=48, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Conv[cv1]/Conv2d[conv]/input.131
        self.module_67 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.133
        ...
        self.module_105 = torch.nn.Conv2d(in_channels=96, out_channels=192, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
        ...
        self.module_108 = torch.nn.Conv2d(in_channels=240, out_channels=192, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
                                          bias=False)  # Model::Model/C3[model]/C3[6]/Conv[cv3]/Conv2d[conv]/input.213
        self.module_109 = torch.nn.BatchNorm2d(num_features=192, eps=0.001,
        ...
        self.module_69 = torch.nn.Conv2d(in_channels=48, out_channels=96, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[0]/Conv[cv1]/Conv2d[conv]/input.137
        self.module_70 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[0]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.139
        ...
        self.module_72 = torch.nn.Conv2d(in_channels=96, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[0]/Conv[cv2]/Conv2d[conv]/input.143
        self.module_73 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[0]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.145
        ...
        self.module_75 = torch.nn.Conv2d(in_channels=48, out_channels=144, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[1]/Conv[cv1]/Conv2d[conv]/input.149
        self.module_76 = torch.nn.BatchNorm2d(num_features=144, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[1]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.151
        ...
        self.module_78 = torch.nn.Conv2d(in_channels=144, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[1]/Conv[cv2]/Conv2d[conv]/input.155
        self.module_79 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[1]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.157
        ...
        self.module_81 = torch.nn.Conv2d(in_channels=48, out_channels=96, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[2]/Conv[cv1]/Conv2d[conv]/input.161
        self.module_82 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[2]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.163
        ...
        self.module_84 = torch.nn.Conv2d(in_channels=96, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[2]/Conv[cv2]/Conv2d[conv]/input.167
        self.module_85 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[2]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.169
        ...
        self.module_87 = torch.nn.Conv2d(in_channels=48, out_channels=96, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[3]/Conv[cv1]/Conv2d[conv]/input.173
        self.module_88 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[3]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.175
        ...
        self.module_90 = torch.nn.Conv2d(in_channels=96, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[3]/Conv[cv2]/Conv2d[conv]/input.179
        self.module_91 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[3]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.181
        ...
        self.module_93 = torch.nn.Conv2d(in_channels=48, out_channels=144, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[4]/Conv[cv1]/Conv2d[conv]/input.185
        self.module_94 = torch.nn.BatchNorm2d(num_features=144, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[4]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.187
        ...
        self.module_96 = torch.nn.Conv2d(in_channels=144, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[4]/Conv[cv2]/Conv2d[conv]/input.191
        self.module_97 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[4]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.193
        ...
        self.module_99 = torch.nn.Conv2d(in_channels=48, out_channels=144, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[5]/Conv[cv1]/Conv2d[conv]/input.197
        self.module_100 = torch.nn.BatchNorm2d(num_features=144, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[5]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.199
        ...
        self.module_102 = torch.nn.Conv2d(in_channels=144, out_channels=48, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[5]/Conv[cv2]/Conv2d[conv]/input.203
        self.module_103 = torch.nn.BatchNorm2d(num_features=48, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[6]/Sequential[m]/Bottleneck[5]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.205
        ...
        self.module_111 = torch.nn.Conv2d(in_channels=192, out_channels=192, kernel_size=[3, 3], stride=[2, 2], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/Conv[model]/Conv[7]/Conv2d[conv]/input.219
        self.module_112 = torch.nn.BatchNorm2d(num_features=192, eps=0.001, momentum=0.03) #Model::Model/Conv[model]/Conv[7]/torch.nn.BatchNorm2d2d[bn]/input.221
        ...
        self.module_114 = torch.nn.Conv2d(in_channels=192, out_channels=96, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[8]/Conv[cv1]/Conv2d[conv]/input.225
        self.module_115 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[8]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.227
        ...
        self.module_129 = torch.nn.Conv2d(in_channels=192, out_channels=192, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
                                          bias=False)  # Model::Model/C3[model]/C3[8]/Conv[cv2]/Conv2d[conv]/input.253
        self.module_130 = torch.nn.BatchNorm2d(num_features=192, eps=0.001,
        ...
        self.module_132 = torch.nn.Conv2d(in_channels=288, out_channels=576, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
                                          bias=False)  # Model::Model/C3[model]/C3[8]/Conv[cv3]/Conv2d[conv]/input.259
        self.module_133 = torch.nn.BatchNorm2d(num_features=576, eps=0.001,
        ...
        self.module_117 = torch.nn.Conv2d(in_channels=96, out_channels=192, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[0]/Conv[cv1]/Conv2d[conv]/input.231
        self.module_118 = torch.nn.BatchNorm2d(num_features=192, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[0]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.233
        ...
        self.module_120 = torch.nn.Conv2d(in_channels=192, out_channels=96, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[0]/Conv[cv2]/Conv2d[conv]/input.237
        self.module_121 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[0]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.239
        ...
        self.module_123 = torch.nn.Conv2d(in_channels=96, out_channels=192, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[1]/Conv[cv1]/Conv2d[conv]/input.243
        self.module_124 = torch.nn.BatchNorm2d(num_features=192, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[1]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.245
        ...
        self.module_126 = torch.nn.Conv2d(in_channels=192, out_channels=96, kernel_size=[3, 3], stride=[1, 1], padding=[1, 1], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[1]/Conv[cv2]/Conv2d[conv]/input.249
        self.module_127 = torch.nn.BatchNorm2d(num_features=96, eps=0.001, momentum=0.03) #Model::Model/C3[model]/C3[8]/Sequential[m]/Bottleneck[1]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.251
        ...
        self.module_135 = torch.nn.Conv2d(in_channels=576, out_channels=192, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/SPPF[model]/SPPF[9]/Conv[cv1]/Conv2d[conv]/input.265
        self.module_136 = torch.nn.BatchNorm2d(num_features=192, eps=0.001, momentum=0.03) #Model::Model/SPPF[model]/SPPF[9]/Conv[cv1]/torch.nn.BatchNorm2d2d[bn]/input.267
        ...
        self.module_141 = torch.nn.Conv2d(in_channels=768, out_channels=384, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/SPPF[model]/SPPF[9]/Conv[cv2]/Conv2d[conv]/input.271
        self.module_142 = torch.nn.BatchNorm2d(num_features=384, eps=0.001, momentum=0.03) #Model::Model/SPPF[model]/SPPF[9]/Conv[cv2]/torch.nn.BatchNorm2d2d[bn]/input.273
        ...
        self.module_144 = torch.nn.Conv2d(in_channels=384, out_channels=384, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/Conv[model]/Conv[10]/Conv2d[conv]/input.277
        ...
        self.module_147 = torch.nn.Conv2d(in_channels=576, out_channels=192, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[13]/Conv[cv1]/Conv2d[conv]/input.285
        ...
        self.module_162 = torch.nn.Conv2d(in_channels=576, out_channels=192, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
        ...
        self.module_171 = torch.nn.Conv2d(in_channels=288, out_channels=96, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=False) #Model::Model/C3[model]/C3[17]/Conv[cv1]/Conv2d[conv]/input.333
        ...
        self.module_186 = torch.nn.Conv2d(in_channels=288, out_channels=96, kernel_size=[1, 1], stride=[1, 1],
                                          padding=[0, 0], dilation=[1, 1], groups=1,
