...
class ofa_yolo_0(torch.nn.Module):
    def __init__(self):
        ...
        self.module_192 = py_nndct.nn.Conv2d(in_channels=192, out_channels=255, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #ofa_yolo_0::ofa_yolo_0/Model[model]/Conv2d[module_240]/ip.1
        self.module_193 = py_nndct.nn.Conv2d(in_channels=384, out_channels=255, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #ofa_yolo_0::ofa_yolo_0/Model[model]/Conv2d[module_241]/ip.3
        self.module_194 = py_nndct.nn.Conv2d(in_channels=768, out_channels=255, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #ofa_yolo_0::ofa_yolo_0/Model[model]/Conv2d[module_242]/ip
