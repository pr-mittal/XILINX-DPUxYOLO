...
from yolov3.pytorchyolo.utils.utils import load_classes, rescale_boxes, non_max_suppression, print_environment_info
...
def run():
    ...
    parser.add_argument("-i", "--images", type=str, default="yolov3/data/samples", help="Path to directory with images to inference")
